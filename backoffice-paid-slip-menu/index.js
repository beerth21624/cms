...
const BackofficePaidSlipMenu = (props) => {
  useEffect(() => {});

  return (
    <Layout title="ZDECOR | เมนูสลิปจ่ายเงิน">
      <body className="backoffice">
        {/* <nav className="navbar navbar-expand-md bg-dark  navbar-light">

                <h4 className="text-light text-uppercase mb-0 py-2"> เมนูสลิปจ่ายเงิน</h4>
                ...
                <div className="collapse navbar-collapse " id="myNavbar">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-3 col-xl-2 col-md-4 sidebar fixed-top">
                                ...
                                <ul className="navbar-nav flex-column mt-4">
                                    <li className="nav-item">
                                        <a href="#" className="nav-link text-light p-3 mb-2 current ">  เมนูสลิปจ่ายเงิน
                            ...
                            <div className="col-lg-9 col-xl-10 col-md-8 ml-auto bg-bg-dark fixed-top py-2 top-navbar">
              ...
              <table className="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">122,000</td>
                    <td className="text-center">Modern Package </td>
...
export default inject('example')(observer(BackofficePaidSlipMenu));
